...
\begin{remark}{Selective disclosure of witnesses}{}
  Note that in the following descriptions, all witnesses are assumed to be kept secret, i.e., none of the $\witness_i$ is disclosed to the verifier.
	In case this is required, as is the case, e.g., in the context of attribute-based credential systems, the relation to be proven can be rewritten as follows:
$$
  \relation'=\set{
	\begin{array}{r}
...
\begin{remark}{Equivalent statements}{}
  ...
  \begin{itemize}
    \item proving knowledge of $(\witness_0,\witness_1)\in\FF_p$ such that $\statement_0=\witness_0G$ and $\statement_1=\witness_1H$, and $\witness_0=\witness_1$.
  Using the above notation, we have $\varphi: (\witness_0,\witness_1)\mapsto (\witness_0G,\witness_1H)$.
  The linear system of equations $A(\witness_0,\witness_1)=b$ is given by $\witness_0-\witness_1=0$.
