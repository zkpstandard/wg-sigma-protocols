...
\subsubsection{Computing the commitment}
\minote{define an aux function that takes as input the statement etc and then returns 32B of randomness to be used for the generation of the commtiment. Explain how the hash function is invoked}
\stnote{once you have this seed, how do you expand it for long commitments}
...
\stnote{void, everything has fixed length in our case}
\end{enumerate}
