...
Recently, Lueks et al.~\cite{zksk}, reported that solely in the years 2018-2019 editions of PETS, ACM CCS, WPES, NDSS,
...
\section{Candidate implementation }
...
At the time of this writing, we are aware of the following implementations:
...
\end{table}
\begin{itemize}
  \item \emph{SCAPI}~\cite{scapi} published in 2020, that supports AND-composition, OR-composition;
  \item zkp~\cite{zkp}, published in 2019 and last udpated in January 2021, supports only AND-composition;
  \item zksk~\cite{zksk}, published in 2019 and last updated in January 2021, supporing AND-composition, OR-composition;
  \item
\end{itemize}
