...
\begin{itemize}
  \item $\vec \commitment \gets \dloglin.\provercommitment(\vec \witness)$
    ...
    \minote{do we have to explain how to do it more in detail?}
...
\minote{Add section on protocols out of scope that can be useful for specific applications, e.g. https://eprint.iacr.org/2014/764.pdf}
