...
\begin{titlepage}
   \begin{center}
       ...
       \vspace{1.0cm}
			 Contributors: Jan Bobolz, Trevor Perrin, ...
       \vfill
       Version: v0.2\\
       \vspace{0.5cm}
       Date: \today\\
...
\begin{itemize}
  ...
  \[
    \hash(\dhlabel \concatblock \curvectx \concatblock \serialize(G) \concat \serialize(\statement_0) \concat \serialize(\statement_1))
  \]
\end{itemize}
...
\begin{itemize}
  ...
  \[
    \hash(\replabel \concatblock \curvectx \concatblock \serialize(G_1) \concat \cdots \concat \serialize(G_m) \concat \serialize(\statement))
  \]
