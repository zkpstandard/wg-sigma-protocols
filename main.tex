...
\minote{I am not returning anything for elements that do not have a metavariable associated}
      ...
      checking the output distribution might be hard, but trivially al simulated transcripts, as well as honest transcripts should verify! }
...
\begin{itemize}
  ...
  \minote{Check that $\challenge\in\CS$ is nonzero and aborts if this is not the case?}
  \begin{enumerate}
      \item
...
\minote{why in bold witness commitment and response}
