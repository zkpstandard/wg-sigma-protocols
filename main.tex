...
$\Sigma$-protocol. Relying on computational (i.e., DDH) assumptions, in [CSSPV16b] it is shown how to generically (i.e., not just two and no further restrictions) compose delayed-input $\Sigma$-protocols obtaining a compound delayed-input $\Sigma$ protocol.
