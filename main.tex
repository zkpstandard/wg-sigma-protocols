...
\stnote{I added this because one of the comments... but how far do we want to go with definitions?}
...
\stnote{just because it works ;) if we sample the randomness for the homogeneous system, we only have c here... just a matter of taste, doesn't make a difference}
