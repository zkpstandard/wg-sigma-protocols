...
\sknote{nooooooo ;) but maybe we can somewhere (outside the definition of sigma protocols, i.e., in Sec 3 or so) explain that (T,c,s) is our convention for the three messages in a sigma protocol?}
